...
/* ---------------- Produkte ---------------- */
var PRODUCTS = [
  { id:'one-plus', slug:'solartisch-sustable-one-edelstahl', name:'Sustable ONE+ Edelstahl', fullName:'Solartisch Sustable ONE+ Edelstahl', shortLabel:'ONE+', price:1750, wp:465, kwp:0.465, material:'Edelstahl, gebürstet', masse:'180 × 110 × 75 cm', inverter:500, rollen:true, img:'/assets/oneplus-gedeckt-garten.jpg', gallery:['/assets/oneplus-gedeckt-garten.jpg','/assets/oneplus-garten.jpg','/assets/oneplus-terrasse-see.jpg','/assets/oneplus-aufgeklappt.jpg','/assets/oneplus-detail.jpg'], badge:'465 Wp · Edelstahl', tagline:'Das Flaggschiff aus gebürstetem Edelstahl.', desc:'Eleganter Solartisch aus gebürstetem Edelstahl mit 465 Wp-Solarmodul und 500 W-Wechselrichter – für Balkon, Terrasse oder Garten.' },
  { id:'one', slug:'solartisch-sustable-one-aluminium', name:'Sustable ONE Aluminium', fullName:'Solartisch Sustable ONE Aluminium', shortLabel:'ONE', price:1650, wp:465, kwp:0.465, material:'Aluminium, anthrazit', masse:'180 × 110 × 75 cm', inverter:500, rollen:true, img:'/assets/one-gedeckt-garten.jpg', gallery:['/assets/one-gedeckt-garten.jpg','/assets/one-garten.jpg','/assets/one-detail.jpg','/assets/one-aufgeklappt.jpg'], badge:'465 Wp · Aluminium', tagline:'Gleiche Leistung, leichter Aluminiumrahmen.', desc:'Solartisch mit pulverbeschichtetem Aluminiumrahmen in Anthrazit und 465 Wp-Solarmodul – leichter und besonders wetterbeständig.' },
...
function ldProduct(p){
  return {
    ...
    "image":(p.gallery||[p.img]),"description":p.desc,"brand":{"@type":"Brand","name":SITE_NAME},
...
function head(o){
  ...
  s += '<link rel="icon" href="data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20viewBox=%270%200%201%201%27/%3E">\n';
  ...
  s += '<link rel="stylesheet" href="/styles.css?v=5">\n';
  var ld = o.jsonld || [];
...
function doc(o, bodyHtml){
  ...
  scripts += '<script src="/app.js?v=5" defer></' + 'script>\n';
  scripts += '<script src="/effects.js?v=5" defer></' + 'script>\n';
  scripts += '<script src="/guide.js?v=5" defer></' + 'script>\n';
  return '<!DOCTYPE html>\n<html lang="de">\n<head>\n' + head(o) + '</head>\n'
...
function footer(){
  ...
  + '      <div style="display:flex; flex-direction:column; gap:8px;"><a href="/" class="logo" style="display:flex; align-items:center; gap:9px; color:#0a0a0c;"><span style="font-weight:600; font-size:19px; letter-spacing:-0.03em; line-height:1; color:#0a0a0c;">sustable<span class="s-dot" style="color:#f07d00;">.</span></span></a><span class="mono" style="font-size:11px; letter-spacing:0.14em; text-transform:uppercase; color:#6e6e73;">Where design meets sustainability</span></div>\n'
