...
function head(o){
  ...
  s += '<link rel="stylesheet" href="/styles.css?v=7">\n';
  var ld = o.jsonld || [];
...
function doc(o, bodyHtml){
  ...
  scripts += '<script src="/app.js?v=7" defer></' + 'script>\n';
  scripts += '<script src="/effects.js?v=7" defer></' + 'script>\n';
  scripts += '<script src="/guide.js?v=7" defer></' + 'script>\n';
  return '<!DOCTYPE html>\n<html lang="de">\n<head>\n' + head(o) + '</head>\n'
